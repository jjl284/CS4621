...
import cs4620.gl.manip.ManipRenderer;
import cs4620.gl.manip.Manipulator;
...
public class PaintManipController implements IDisposable {
	...
	public PaintManipController(RenderEnvironment re, Scene s) {
		scene = s;
		
		//TODO: Get the component o object
