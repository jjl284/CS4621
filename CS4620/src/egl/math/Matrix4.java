...
public class Matrix4 implements Cloneable {
	...
	/**
	 * Column Constructor
	 * @param c0 [{@link Vector4 ARR}] Column 1
	 * @param c1 [{@link Vector4 ARR}] Column 2
	 * @param c2 [{@link Vector4 ARR}] Column 3
	 * @param c3 [{@link Vector4 ARR}] Column 4
	 */
	 ...
	 * @return Out
	 */
	public Vector4 getColumn(int c, Vector4 out) {
	...
	public Vector4 getColumn(int c) {
		return new Vector4(m[c], m[c + 4], m[c + 8], m[c + 12]);
	}
	 ...
	 * @return Out
	 */
	public Matrix4 mul(Matrix4 mat, Matrix4 out) {
		return out.set(
				innerProduct(this, mat, 0, 0),
				innerProduct(this, mat, 0, 1),
				innerProduct(this, mat, 0, 2),
