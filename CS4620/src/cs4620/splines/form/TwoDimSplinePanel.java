...
public class TwoDimSplinePanel extends SplinePanel{
	...
	/**
	 * Constructor
	 * @param index Index of the SplinePanel in the SplineScreen
	 * @param spline The underlying BSpline
	 */
	public TwoDimSplinePanel(int index, BSpline spline) {
		this.index = index;
		this.spline = spline;
		this.selected = -1;
	}
	...
	public void draw() {
		...
		drawAxes();
		drawControlPoints();
		drawSpline(ControlFrame.drawNormals, ControlFrame.drawTangents);
	}
	...
	public void drawControlPoints() {
		...
		GL11.glPointSize(TwoDimSplinePanel.VERTEX_RADIUS);
